...
//summarized form input validation on submit
function onSubmitFormInputValidation () {
    var regexname=/^([a-zA-Z ]{2,20})$/;
    var fname = document.getElementById("FirstName").value;
    var lname = document.getElementById("LastName").value;
    var password1 = document.getElementById("Password1").value;
    ...
    if (fname != "") {
        if (!fname.match(regexname)){
            hasNoError = false;
            document.getElementById("FormInput-ErrorText").innerText="Please follow correct input formats.";
