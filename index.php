    ...
    <div class="container">
        <div class="row" id="landingcontent">
            ...
            <div class="col-lg" id="landingcontent-firstcolumn">
                <form id="loginform" method="POST" action="process-controllers/controls-login.php">
                    <h5 style="font-family: Verdana; text-align: center">Account Login</h5>
                    <!-- server-side error prompt-->
                    <?php
                    if (isset($_SESSION['Login_Error'])) { ?>
                        <div class="form-group rounded" id="ServerSide-ErrorContainer">
                            <p class="text-center" id="FormInput-ErrorText"><?php echo $_SESSION['Login_Error']?></p>
                        </div>
                        <?php
                    }
